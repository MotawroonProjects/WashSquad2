...
public class TimeAmAdapter extends RecyclerView.Adapter<TimeAmAdapter.MyHolder> {
    ...
    public TimeAmAdapter(List<TimeDataModel.TimeModel> timeModelList, Context context) {
